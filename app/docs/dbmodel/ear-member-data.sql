...
values(1, '상어', 'shark@test.com', password('1111'), '2021-12-06', 1);
insert into member(member_no, nickname, email, password, created_dt, active)
values(2, '사자', 'lion@test.com', password('1111'), '2021-12-06', 1);
insert into member(member_no, nickname, email, password, created_dt, active)
values(3, '선장', 'captain@test.com', password('1111'), '2021-12-07', 1);
insert into member(member_no, nickname, email, password, created_dt, active)
