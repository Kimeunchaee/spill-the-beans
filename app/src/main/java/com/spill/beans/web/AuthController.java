...
public class AuthController {
  ...
  @RequestMapping(value = {"/auth/login", "/auth/fail"})
  public ModelAndView login(String email, String password, String saveEmail, HttpServletResponse response, HttpSession session, HttpServletRequest request) throws Exception {
    ...
    if (requestUrl.contains("/auth/fail")) {
