...
<form method='post' enctype="multipart/form-data">
	<input type='hidden' name='no' value='${member.no}'>
		...
		<div class="mb-3 row">
		  ...
		  <div class="col-sm-6">
		    <input id='f-no' type='text' name='no' class="form-control-plaintext" value='${member.no}' readonly>
		  </div>
		</div>
		<div class="mb-3 row">
		  <label for='f-nickname' class="col-sm-2 col-form-label">닉네임</label>
		  <div class="col-sm-6">
		    <input id='f-nickname' type='text' name='nickname' class="form-control-plaintext" value="${member.nickname}" readonly>
		  </div>
		</div>
		<div class="mb-3 row">
		  <label for='f-email' class="col-sm-2 col-form-label">이메일</label>
		  <div class="col-sm-10">
		    <input id='f-email' type='email' name='email' class="form-control-plaintext" value="${member.email}" readonly>
		  </div>
		</div>
		<div class="mb-3 row">
	...
	<div class="btn_wrap">
	  ...
	  <a href='delete?no=${member.no}' class ="btn btn-outline-dark">탈퇴</a>
